// Copied and adapted from https://github.com/sindresorhus/sparkly
// With permission: https://github.com/sindresorhus/sparkly/blob/master/license
'use strict'
...
module.exports = function (numbers, opts) {
  ...
  return numbers.map(function (el) {
    var tickIndex = Math.ceil((el - min) / (max - min) * ticks.length)
